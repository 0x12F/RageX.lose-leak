...
public class ModuleManager implements Jsonable, Util {
    ...
    public void init() {
        ...
        modules.add(new ArrayListHud() {{ hidden = true; }}); // ArrayList HUD sadece Elements'te gözüksün
        modules.add(new Shader()); // Shader modülünü ekle
    }
    ...
    public void onKeyPressed(int eventKey) {
        ...
        // ClickGui açıksa bind dinliyordu onu kapattım işte -bomb_crash
        if (me.alpha432.oyvey.features.modules.client.ClickGui.getInstance().isEnabled()) return;
        this.modules.forEach(module -> {
