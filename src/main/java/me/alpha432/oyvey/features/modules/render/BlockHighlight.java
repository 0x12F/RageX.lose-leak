...
public class BlockHighlight extends Module {
    private final Setting<Boolean> renderPlayer = this.register(new Setting<>("Player", true));
    private final Setting<Boolean> renderCrystal = this.register(new Setting<>("Crystal", true));
    private final Setting<Boolean> renderHand = this.register(new Setting<>("Hand", true));
    private final Setting<Boolean> renderItem = this.register(new Setting<>("Item", true));
